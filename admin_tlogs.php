      ...
      <div class="card">
         <div class="card-body">
            ...
            <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap w-100">
               ...
               <tbody>
               <?php foreach ($Logs->ToolLogsDataAll()['Response'] as $Ak => $Av) { ?>
                  <tr>
                     <th scope="row"><?php echo $Av['id']; ?></th>
                     <td><?php if ($Av['userID'] != 0) { echo '<a href="admin_user.php?id='.$Av['userID'].'">'.$User->UserDataID($Av['userID'], 1)['username'].'</a>'; } else { echo 'Not registered'; } ?></td>
                     <td><?php echo $Av['type']; ?></td>
                     <td><?php echo $Av['value']; ?></td>
